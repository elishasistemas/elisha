...
-- [FIM: 001_create_core_tables.sql]
...
-- [FIM: 002_create_rls_policies.sql]
...
-- [FIM: 003_create_invites_system.sql]


-- ============================================
-- MIGRATION: 003_5_add_profiles_missing_columns.sql
-- ============================================
...
-- [FIM: 003_5_add_profiles_missing_columns.sql]
...
-- [FIM: 20251021000003_roles_active_role.sql]
...
-- [FIM: 004_create_checklist_system.sql]
...
-- [FIM: 20251021000000_empresa_dual_approval.sql]
...
-- [FIM: 20251021000001_os_ordering_view.sql]
...
-- [FIM: 20251021000002_rls_more_tables.sql]
...
-- [FIM: 20251022000000_add_user_id_to_profiles.sql]
...
-- [FIM: 20251022000001_fix_active_role_constraint.sql]
...
-- [FIM: 20251022000002_fix_empresas_select_for_anon.sql]
...
-- [FIM: 20251022000003_fix_invite_permissions.sql]
...
-- [FIM: 20251022000004_fix_invites_created_by.sql]
...
-- [FIM: 20251022000005_fix_invites_public_select.sql]
...
-- [FIM: 20251022000006_fix_invites_select_policies_roles.sql]
...
-- [FIM: 20251022000007_fix_invites_select_rls.sql]
...
-- [FIM: 20251022000008_fix_revoke_invite_permissions.sql]
...
-- [FIM: 20251022000009_grant_empresas_select_to_anon.sql]
...
-- [FIM: 20251022000010_remove_gestor_role.sql]
...
-- [FIM: 20251024000000_add_client_contract_and_equipment_fields.sql]
...
-- [FIM: 20251024000001_add_quem_solicitou_to_ordens_servico.sql]
...
-- [FIM: 20251024000002_fix_all_rls_policies_active_role.sql]
...
-- [FIM: 20251024000003_fix_profiles_roles_active_role.sql]
...
-- [FIM: 20251027000000_create_os_status_history_and_accept_decline_rpcs.sql]
...
-- [FIM: 20251027000001_fix_os_accept_decline_rls_and_functions.sql]
...
-- [FIM: 20251028000000_create_evidencias_and_laudo.sql]
...
-- [FIM: 20251028000001_create_os_checkin_rpc.sql]
...
-- [FIM: 20251029000000_seed_roles_existing_users.sql]
...
-- [FIM: 998_add_user_id_to_colaboradores.sql]
...
-- [FIM: 999_fix_accept_invite_create_colaborador.sql]
