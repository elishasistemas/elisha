...
import type { CorrectiveOSData, ElevatorState, HistoryEntry } from '@/types/service-orders'
 ...
 * - Estrutura idêntica ao Chamado, mas com lógica de negócio diferente
 */
export function CorrectiveOS({
  osId,
  empresaId,
  data,
  history = [],
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        console.error('[CorrectiveOS] Erro ao carregar dados:', error)
      } finally {
        setLoading(false)
      }
    }
  ...
  useEffect(() => {
    const saveLaudo = async () => {
      ...
      try {
        ...
        console.log('[CorrectiveOS] Laudo salvo automaticamente')
      } catch (error) {
        console.error('[CorrectiveOS] Erro ao salvar laudo:', error)
  ...
  const handleFileUpload = async (file: File, tipo: 'foto' | 'video' | 'audio') => {
    ...
    try {
      ...
      console.error('[CorrectiveOS] Erro ao fazer upload:', error)
  ...
  const handleAddNote = async () => {
    ...
    try {
      ...
      console.error('[CorrectiveOS] Erro ao adicionar nota:', error)
